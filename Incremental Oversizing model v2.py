...
#%%
# =========================================
# Runs below scenario for incremental build
# =========================================
...
#%%
# ====================================
# Runs below scenario to find cheapest
# ====================================
...
find_cheapest(
        ...
        operating_period=10,        # in years
        capacity_factor=0.1,        # % terms 0.1 = 10 %
        demand_increase=1.20,       # in % terms 1.1 = 10% increase (NB change)
        base_bos_cost=1.00,         # in $ per watt installed
        base_module_cost=1.00,      # in $ per watt installed
        operation_cost=0.50,        # in $ per watt installed
        bos_reduction=0.7,         # in % terms 0.1 = 10% reduction
        module_reduction=0.7,      # in % terms 0.1 = 10% reduction
        discount_rate=0.05,         # in % terms 0.1 = 10% discount rate
        rebuild_fixed=250)            # Fixed rebuild cost in $USD
